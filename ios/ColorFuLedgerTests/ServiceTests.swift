...
private func insertTestTag(db: Database, id: String = "tag1", name: String = "Food") throws {
    let tag = ColorFuLedger.Tag(id: id, name: name, colorHex: "#00FF00")
    try tag.insert(db)
}
...
struct BackupServiceTests {
    ...
    @Test func roundTripPreservesData() throws {
        ...
        let (catCount, tagCount, ttCount) = try dbQueue.read { db in
            (try Category.fetchCount(db), try ColorFuLedger.Tag.fetchCount(db), try TransactionTag.fetchCount(db))
        }
        #expect(catCount == 2)
        #expect(tagCount == 1)
        #expect(ttCount == 1)
...
struct PDFExportServiceTests {
    ...
    @Test func breakdownSingleCategory() throws {
        ...
        let catDict = ["c1": ColorFuLedger.Category(id: "c1", nameKey: "cat_food", iconName: "cart", colorHex: "#FF0000", type: "expense", sortOrder: 0, isCustom: true)]
    ...
    @Test func breakdownMultipleCategories() throws {
        ...
        let catDict: [String: ColorFuLedger.Category] = [
            "c1": ColorFuLedger.Category(id: "c1", nameKey: "Food", iconName: "cart", colorHex: "#FF0000", type: "expense", sortOrder: 0, isCustom: true),
            "c2": ColorFuLedger.Category(id: "c2", nameKey: "Transport", iconName: "car", colorHex: "#00FF00", type: "expense", sortOrder: 1, isCustom: true),
        ]
    ...
    @Test func breakdownBuiltinCategoryUsesLocalization() throws {
        ...
        let catDict = ["c1": ColorFuLedger.Category(id: "c1", nameKey: "cat_food", iconName: "cart", colorHex: "#FF0000", type: "expense", sortOrder: 0, isCustom: false)]
