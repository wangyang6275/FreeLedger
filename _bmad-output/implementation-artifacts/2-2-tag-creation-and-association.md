...
### File List
- ios/FreeLedger/data/model/Tag.swift (new)
- ios/FreeLedger/data/model/TransactionTag.swift (new)
- ios/FreeLedger/data/database/TagDAO.swift (new)
- ios/FreeLedger/data/repository/TagRepository.swift (new)
- ios/FreeLedger/ui/components/TagSelector.swift (new — includes FlowLayout)
- ios/FreeLedger/data/database/AppDatabase.swift (modified — migration v2)
- ios/FreeLedger/data/repository/TransactionRepository.swift (modified — tagIds + tag methods)
- ios/FreeLedger/ui/record/RecordView.swift (modified — TagSelector integration)
- ios/FreeLedger/ui/record/RecordViewModel.swift (modified — tagIds in saveTransaction)
- ios/FreeLedger/ui/detail/TransactionDetailView.swift (modified — tag display + edit)
- ios/FreeLedger/ui/detail/TransactionDetailViewModel.swift (modified — tags state + editTagIds)
- ios/FreeLedger/ui/home/HomeView.swift (modified — tagRepository parameter)
- ios/FreeLedger/ContentView.swift (modified — tagDAO/tagRepository creation + passing)
