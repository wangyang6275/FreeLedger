...
- ios/FreeLedger/domain/model/TransactionSummary.swift (new)
- ios/FreeLedger/util/DateFormatter+App.swift (new)
- ios/FreeLedger/ui/components/SummaryCard.swift (new)
- ios/FreeLedger/ui/components/TransactionCard.swift (new)
- ios/FreeLedger/ui/home/HomeViewModel.swift (new)
- ios/FreeLedger/ui/home/HomeView.swift (modified — complete rewrite)
- ios/FreeLedger/data/database/TransactionDAO.swift (modified — added getByMonth)
- ios/FreeLedger/data/database/CategoryDAO.swift (modified — added getById, getAllAsDict)
- ios/FreeLedger/data/repository/TransactionRepository.swift (modified — added getTransactionsForMonth, getMonthlySummary)
- ios/FreeLedger/data/repository/CategoryRepository.swift (modified — added getAllAsDict)
- ios/FreeLedger/ContentView.swift (modified — HomeViewModel injection, auto-refresh)
- ios/FreeLedger/i18n/Localizable.strings (modified — added 10+ strings)
- ios/FreeLedger/i18n/en.lproj/Localizable.strings (modified — added 10+ strings)
- ios/FreeLedger/ui/components/CategoryIconView.swift (new — code review: shared icon component)
- ios/FreeLedger/ui/record/RecordView.swift (modified — code review: added save button + selection mode)
- ios/FreeLedger/ui/components/CategoryGrid.swift (modified — code review: external selectedId, removed internal state)
- ios/FreeLedger/data/model/Category.swift (modified — code review: added Equatable)
